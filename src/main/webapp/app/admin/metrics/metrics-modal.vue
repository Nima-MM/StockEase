    ...
    <div class="pad" v-for="(entry, key) of filteredThreadDump" :key="key">
      <h6>
        ...
        <a @click="entry.show = !entry.show" href="javascript:void(0);">
          <span :hidden="entry.show">Zeigen</span>
          <span :hidden="!entry.show">Verstecken</span>
        </a>
      </h6>
      ...
      <table class="table table-sm table-responsive" aria-describedby="Metrics">
        <thead>
          <tr>
            <th scope="col">Geblockte Zeit</th>
            <th scope="col">Geblockte Zahl</th>
            <th scope="col">Gewartete Zeit</th>
            <th scope="col">Gewartete Anzahl</th>
