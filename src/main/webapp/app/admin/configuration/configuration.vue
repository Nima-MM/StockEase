<template>
  <div>
    <h2 id="configuration-page-heading" data-cy="configurationPageHeading">Konfiguration</h2>

    <div v-if="allConfiguration && configuration">
      <span>Filter (nach Präfix)</span> <input type="text" v-model="filtered" class="form-control" />
