...
import static de.hoomit.stockmanagement.domain.ProductAsserts.*;
...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().stock(DEFAULT_STOCK).name(DEFAULT_NAME).image(DEFAULT_IMAGE).ean(DEFAULT_EAN).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().stock(UPDATED_STOCK).name(UPDATED_NAME).image(UPDATED_IMAGE).ean(UPDATED_EAN).description(UPDATED_DESCRIPTION);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.stock(UPDATED_STOCK).name(UPDATED_NAME).image(UPDATED_IMAGE).ean(UPDATED_EAN).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.stock(UPDATED_STOCK).name(UPDATED_NAME).image(UPDATED_IMAGE);
